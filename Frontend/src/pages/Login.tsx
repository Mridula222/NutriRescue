      ...
      <div className="px-6 md:px-12 py-14 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="hidden md:block">
          <h1 className="text-4xl font-extrabold text-gray-900">
            Welcome back to <span className="text-green-600">NutriRescue</span>
          </h1>
          <p className="mt-4 text-gray-600 text-lg max-w-xl">
            Login and continue donating or claiming safe surplus meals with
            expiry tracking and impact insights.
          </p>
